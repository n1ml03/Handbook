  ...
  const getColorScheme = () => {
    if (blackTheme) {
      return {
        ...
        inputClasses: 'w-full bg-gray-900/50 border border-gray-700 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-gray-500 transition-all text-white',
        checkboxClasses: 'rounded border-gray-700 text-gray-900 focus:ring-gray-500/20',
      ...
      return {
        ...
        inputClasses: `w-full bg-dark-primary/50 border border-dark-border rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-${accentColor} transition-all`,
        checkboxClasses: `rounded border-dark-border text-${accentColor} focus:ring-${accentColor}/20`,
          ...
          <div className="flex-1 relative">
            ...
            {filterFields.find(f => f.key === 'search') && (
              <input
                ...
                className={`w-full ${blackTheme ? 'bg-gray-900/70 border-gray-700/50 focus:border-gray-500' : 'bg-dark-card/70 border-dark-border/50 focus:border-accent-cyan'} backdrop-blur-sm border rounded-xl pl-10 pr-4 py-3 focus:outline-none focus:ring-2 ${blackTheme ? 'focus:ring-gray-500/20' : 'focus:ring-accent-cyan/20'} transition-all placeholder-gray-500 text-white`}
